...
function Footer() {
    ...
    return (
      <footer className='w-sc bg-foregroundPrimary text-backgroundPrimary py-7 max-xl:px-5'>
          <div className='flex max-w-[1200px] w-full mx-auto gap-2 uppercase pb-5 max-lg:flex-wrap'>
              <div className='w-1/4 max-lg:w-1/2 max-sm:w-full max-sm:text-center max-sm:flex max-sm:flex-col max-sm:items-center'>
                  ...
                  <p className='flex flex-row items-start gap-1 mt-1'><FaEnvelope className='mt-0.5'/> - <Link className='duration-150 hover:text-accentPrimary' href="mailto: cristian.tanasescu@healthymedical.ro">Cristian.tanasescu<br/>@healthymedical.ro</Link></p>
              </div> 
