...
function HomeDoctor() {
  ...
  return (
    <div className='relative h-full w-1/2 bg-[#00ff00]' onMouseOver={()=>{
        ...
        <video id='home-doctor-video' loop muted className='absolute top-0 left-0 w-full h-full object-cover z-0 ease-out duration-300 brightness-[0.20] group-hover:brightness-[0.75]'>
        ...
        <div className='relative z-10 h-full flex flex-col items-center justify-center pb-7'>
          <h3 className='text-backgroundPrimary uppercase text-5xl text-center align-middle font-extrabold max-w-[500px] h-[115px] flex items-center justify-center'>{translation('doctor-heading')}</h3>
