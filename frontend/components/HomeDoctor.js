  ...
  return (
    <div className='relative h-full w-1/2 group' onMouseOver={()=>{
        ...
        <div className='relative z-10 h-full flex flex-col items-center justify-center pb-7 '>
          <h3 className='text-backgroundPrimary uppercase text-5xl text-center align-middle font-extrabold max-w-[500px] h-[115px] flex items-center justify-center max-md:text-3xl max-sm:text-2xl'>{t('doctor-heading')}</h3>
