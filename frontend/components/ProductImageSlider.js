  ...
  return (
    <div className='px-8'>
        ...
        <div className='w-full flex flex-row gap-2 pt-4'>
            <button className='p-3 aspect-square w-1/4 transition-all duration-300 hover:p-2' onClick={()=>{switchImage(img1)}}>
               <Image
                  src={img1}
                  width={1000}
                  height={1000}   
            ...
            <button className='p-3 aspect-square w-1/4 transition-all duration-300 hover:p-2' onClick={()=>{switchImage(img2)}}>
               <Image
                  src={img2}
                  width={1000}
                  height={1000}
            ...
            <button className='p-3 aspect-square w-1/4 transition-all duration-300 hover:p-2' onClick={()=>{switchImage(img3)}}>
               <Image
                  src={img3}
                  width={1000}
                  height={1000}   
            ...
            <button className='p-3 aspect-square w-1/4 transition-all duration-300 hover:p-2' onClick={()=>{switchImage(img4)}}>
               <Image
                  src={img4}
                  width={1000}
                  height={1000}   
