                  ...
                  <TableRow key={row.id}>
                    ...
                    >
                      {parseInt(row.status) === 0 ? (
                        <>
                          <div
                            className={`w-max mx-auto rounded-xl px-3 py-[2px] text-foregroundSecondary bg-[#e74d3d]`}
                          >
                        ...
                        <>
                          {parseInt(row.status) === 1 ? (
                            <>
                              <div
                                className={`w-max mx-auto rounded-xl px-3 py-[2px] text-foregroundSecondary bg-[#f1c40d]`}
                              >
                            ...
                            <>
                              {parseInt(row.status) === 2 ? (
                                <>
                                  <div
                                    className={`w-max mx-auto rounded-xl px-3 py-[2px] text-foregroundSecondary bg-[#e77e22]`}
                                  >
                                ...
                                <>
                                  {parseInt(row.status) === 3 ? (
                                    <>
                                      <div
                                        className={`w-max mx-auto rounded-xl px-3 py-[2px] text-foregroundSecondary bg-[#3397dc]`}
                                      >
                                        {t(
                                    ...
                                    <>
                                      {parseInt(row.status) === 4 ? (
                                        <>
                                          <div
                                            className={`w-max mx-auto rounded-xl px-3 py-[2px] text-foregroundSecondary bg-[#2980b9]`}
                                          >
                                            {t(
                                        ...
                                        <>
                                          {parseInt(row.status) === 5 ? (
                                            <>
                                              <div
                                                className={`w-max mx-auto rounded-xl px-3 py-[2px] text-foregroundSecondary bg-[#2ecd70]`}
                                              >
                                                {t(
