      ...
      <div className="relative flex max-w-[1200px] mx-auto justify-between items-center content-center h-full py-2 max-md:px-5 max-[1200px]:px-4">
        ...
        <div className="w-1/2 flex row justify-end gap-[6px] max-md:hidden">
                ...
                <div>
                    {
                      isLogin ? (
                        <Link href="/register" locale={currentLocale} className=" h-full border-[2px] border-foregroundPrimary rounded-lg flex items-center content-center px-4">
                          {t("register-btn")}
                        </Link>
                      ) : (
                        <Link href="/login" locale={currentLocale} className=" h-full border-[2px] border-foregroundPrimary rounded-lg flex items-center content-center px-4">
                          {t("login-btn")}
                        </Link>
                      )
                    }
