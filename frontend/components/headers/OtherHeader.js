...
function OtherHeader({ currentLocale }) {
  ...
  return (
    <header
      className={`fixed block top-0 left-0 w-full h-[75px]  text-foregroundPrimary z-50 bg-backgroundPrimary ${
        headerWhite ? "shadow-lg" : ""
      } transition-all duration-300  header-white`}
    >
      <div className="relative flex max-w-[1200px] mx-auto justify-between items-center content-center h-full py-2 max-md:px-5 max-[1200px]:px-4">
        <div className="h-full w-1/5 max-md:w-1/2">
          ...
          >
            <Image src={renadylLogo} alt="Renadyl" className="h-full w-max" />
          </Link>
        </div>
