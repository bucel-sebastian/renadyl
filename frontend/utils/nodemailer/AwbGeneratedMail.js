...
export const sendSamedayAwbEmail = async (data) => {
                                  ...
                                  <td class="pad">
                                    ...
                                    >
                                      <p style="margin: 0">
                                        ${
                                          data.lang === "ro"
                                            ? `Pentru a vă bucura de contul dvs., faceți clic pe "Activați contul" de mai jos pentru a vă activa contul, linkul de activare este valabil timp de 7 zile și poate fi folosit o singură dată.`
                                            : `To enjoy your account, click "Activate account" below to activate your account, the activation link is valid for 7 days and can be used only once.`
                                        }
                                      </p>
                                    </div>
                                  </td>
