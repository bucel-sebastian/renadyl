...
export const sendInvoiceEmail = async (data) => {
  ...
  const mailOptions = {
    ...
    subject: `${
      data.lang === "ro"
        ? "Factura pentru comanda dvs. a fost generat!"
        : "The invoice for your order has been generated!"
    }`,
    html: `
                                    ...
                                    <td class="pad">
                                      ...
                                      >
                                        <p style="margin: 0">
                                          ${
                                            data.lang === "ro"
                                              ? `Am generat factura pentru comanda #${data.order_id}, aceasta este atașată în acest mail sau poate fi descărcată din magazinul nostru folosind contul de client.`
